...
# Видалити ці залежності по одному, а потім встановити їх з файлу
# requirements.txt. Видалити всі залежності однією командою, використовуючи
# файл requirements.txt, при цьому видалення повинні бути автоматичним без
